# How to contribute to cozy-linai?
...
- What is the version of the cozy-linai app?
...
```
$ git clone github.com/cozy/cozy-linai.git
$ cd cozy-linai
$ git remote add fork git://github.com/yourusername/cozy-linai.git
```
...
Go to https://github.com/yourusername/cozy-linai and select your branch. Click the 'Pull Request' button and fill out the form.
...
The cozy-linai is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-linai/issues/new
...
[localization]: https://github.com/cozy/cozy-linai/blob/master/README.md#localization
